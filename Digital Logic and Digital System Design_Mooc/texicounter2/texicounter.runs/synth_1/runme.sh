...
HD_PWD='C:/Users/sh/Desktop/texicounter2/texicounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Taxi_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Taxi_Counter.tcl
