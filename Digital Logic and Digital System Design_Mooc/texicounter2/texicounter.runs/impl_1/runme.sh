...
HD_PWD='C:/Users/sh/Desktop/texicounter2/texicounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Taxi_Counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Taxi_Counter.tcl -notrace
