...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/counter/counter.cache/wt [current_project]
  set_property parent.project_path D:/counter/counter.xpr [current_project]
  set_property ip_repo_paths D:/counter/counter.srcs [current_project]
  set_property ip_output_repo D:/counter/counter.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet D:/counter/counter.runs/synth_1/counter.dcp
  read_xdc D:/counter/counter.srcs/constrs_1/new/yueshu.xdc
  link_design -top counter -part xc7a35tcsg324-3
